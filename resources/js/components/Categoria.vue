            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" @click="registrarCategoria()"
                                class="btn btn-primary">Guardar
                        </button>
                        <button type="button" v-if="tipoAccion==2" @click="actualizarCategoria()"
    ...
    export default {
        data() {
            return {
                ...
                modal: 0,
                tituloModal: '',
                tipoAccion: 0, //2 para actualizar, 1 para registrar,
                errorCategoria: 0, // 0 es qe no hay errores
        ...
        methods: {
            ...
            registrarCategoria() {
                if (this.validarCategoria()) { //si este metodo retorna 1, entra el if, sino, prosigue a introducir los datos
                    return;
                }
                let me = this;
            ...
            desactivarCategoria(id) {
                ...
                SwalWithBootstrapButtons({
                    title: 'Estas seguro de desactivarla?',
                    type: 'warning',
                    ...
                    if (result.value) {
                        ...
                        //se hace la peticion para desactivar la categoria.
                        let me = this;
            ...
            activarCategoria(id) {
                ...
                SwalWithBootstrapButtons({
                    title: 'Estas seguro de activarla?',
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Aceptar!',
                    cancelButtonText: 'Cancelar!',
